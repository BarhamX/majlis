...
| DLY-005 | Completed-state attempt pointer | `DailyLoopPostgreSqlTests.AcceptedAttempt_SurvivesApplicationRestart`; hosted Backend CI run `33177107954` | Verified |
